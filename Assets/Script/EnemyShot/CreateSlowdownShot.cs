...
public class CreateSlowdownShot : MonoBehaviour
{
    ...
    public const string SHOTNAME = "Enemy/EnemyShot/EnemySlowDownShot";
    ...
    private void Update()
    {
        ...
        if (isShooting)
        {
            ...
            prefav.GetComponent<InformationEnemyShot>().angleZ = transform.parent.rotation.eulerAngles.z;
        }
    }
